...
const INITIAL_PROJECTS = [
  {
    ...
    tasks: [
      ...
      { id: 's07', text: 'S07: Probar URLs en celular Android', done: false, date: '2026-04-21' },
    ],
  },
  {
    id: 'recibos',
    ...
    color: '#f59e0b',
    hito: { label: 'v2.1 validada + empaquetada .exe', scheduled: '2026-04-25', real: '' },
    tasks: [
      { id: 'r01', text: 'R01: Correr v2.1 con los 402 PDFs reales', done: false, date: '2026-04-21' },
      { id: 'r02', text: 'R02: Verificar que errores bajaron vs v2.0', done: false, date: '2026-04-21' },
      { id: 'r03', text: 'R03: Validar 66 recibos sin firma con RRHH', done: false, date: '2026-04-22' },
      { id: 'r04', text: 'R04: Revisar ~6 PDFs sin período detectado', done: false, date: '2026-04-22' },
      { id: 'r05', text: 'R05: Verificar Salida A — por empleado (84 PDFs)', done: false, date: '2026-04-23' },
      { id: 'r06', text: 'R06: Verificar Salida B — por mes', done: false, date: '2026-04-23' },
      { id: 'r07', text: 'R07: Cruzar 84 empleados detectados vs nómina real (~90)', done: false, date: '2026-04-24' },
      { id: 'r08', text: 'R08: Empaquetar como .exe para distribución sin Python', done: false, date: '2026-04-25' },
    ],
  },
  {
    id: 'catalogo',
    ...
    color: '#0ea5e9',
    hito: { label: 'Catálogo publicado con imágenes y hosting', scheduled: '2026-04-25', real: '' },
    tasks: [
      ...
      { id: 'cat04', text: 'CAT04: Decidir hosting (Netlify o Google Sites)', done: false, date: '2026-04-21' },
      { id: 'cat05', text: 'CAT05: Agregar logo real de Abarca en header', done: false, date: '2026-04-22' },
      { id: 'cat06', text: 'CAT06: Cargar imágenes combos (Google Drive → URL directa)', done: false, date: '2026-04-23' },
      { id: 'cat07', text: 'CAT07: Filtro por stock (mostrar solo disponibles)', done: false, date: '2026-04-24' },
      { id: 'cat08', text: 'CAT08: Publicar y probar URL final', done: false, date: '2026-04-25' },
    ],
  },
  {
    id: 'cobranzas',
    ...
    tasks: [
      ...
      { id: 'c04', text: 'C04: v4.0 Entregable 1 — base (6 mejoras)', done: false, date: '2026-05-12' },
      { id: 'c05', text: 'C05: v4.0 Entregable 2 — nuevos medios de pago', done: false, date: '2026-05-20' },
      { id: 'c06', text: 'C06: v4.0 Entregable 3 — vales y flujo final', done: false, date: '2026-05-27' },
      { id: 'c07', text: 'C07: Testing Moto Edge 60 + iPhone Juan Ángel', done: false, date: '2026-06-03' },
      { id: 'c08', text: 'C08: Deploy en Claude Code + Vercel', done: false, date: '2026-06-05' },
      { id: 'c09', text: 'C09: Backend real — Google Sheets + Apps Script', done: false, date: '2026-06-10' },
  ...
  },
  {
    ...
    color: '#10b981',
    hito: { label: 'Dashboard con datos reales de API funcionando', scheduled: '2026-05-09', real: '' },
    tasks: [
      { id: 'v01', text: 'V01: Revisar estado actual del dashboard', done: false, date: '2026-04-28' },
      { id: 'v02', text: 'V02: Probar endpoints API Humand con key real', done: false, date: '2026-04-28' },
      { id: 'v03', text: 'V03: Mapear campos API → dashboard (círculo, líder)', done: false, date: '2026-04-29' },
      { id: 'v04', text: 'V04: Conectar datos reales al dashboard', done: false, date: '2026-04-30' },
      { id: 'v05', text: 'V05: Validar datos 32 empleados vs Humand', done: false, date: '2026-05-05' },
      { id: 'v06', text: 'V06: Decidir embed vs hosting externo', done: false, date: '2026-05-07' },
      { id: 'v07', text: 'V07: Publicar y entregar al equipo', done: false, date: '2026-05-09' },
    ],
  },
  {
    id: 'visitas',
    ...
    color: '#8b5cf6',
    hito: { label: 'Módulo operativo en piloto con repositores', scheduled: '2026-05-09', real: '' },
    tasks: [
      { id: 'vis01', text: 'VIS01: Validar flujo final con dueños', done: false, date: '2026-05-05' },
      { id: 'vis02', text: 'VIS02: Construir prototipo en Claude Code', done: false, date: '2026-05-06' },
      { id: 'vis03', text: 'VIS03: Prueba en celular real + correcciones', done: false, date: '2026-05-07' },
      { id: 'vis04', text: 'VIS04: Backend Google Sheets + Apps Script', done: false, date: '2026-05-12' },
      { id: 'vis05', text: 'VIS05: Login abarcano + PIN + GPS + foto', done: false, date: '2026-05-13' },
      { id: 'vis06', text: 'VIS06: Offline + semáforo sync 🟢/🟡', done: false, date: '2026-05-14' },
      { id: 'vis07', text: 'VIS07: Piloto con 2-3 repositores reales', done: false, date: '2026-05-19' },
      { id: 'vis08', text: 'VIS08: Correcciones post-piloto', done: false, date: '2026-05-22' },
    ],
  },
  {
    id: 'pop',
    ...
    tasks: [
      ...
      { id: 'p02', text: 'P02: Correcciones post-prueba celular', done: false, date: '2026-05-12' },
      { id: 'p03', text: 'P03: Catálogo real 28 productos en Google Sheet', done: false, date: '2026-05-12' },
      { id: 'p04', text: 'P04: Padrón de clientes cargado (500-2000)', done: false, date: '2026-05-13' },
      { id: 'p05', text: 'P05: Backend Apps Script — pedidos + catálogo', done: false, date: '2026-05-14' },
      { id: 'p06', text: 'P06: Alertas canal/categoría + comodato', done: false, date: '2026-05-19' },
      { id: 'p07', text: 'P07: 4 roles funcionando (Usuario/Enlace/Gestor/Stocker)', done: false, date: '2026-05-21' },
      { id: 'p08', text: 'P08: Offline + localStorage + semáforo sync', done: false, date: '2026-05-22' },
      { id: 'p09', text: 'P09: Piloto con preventistas reales', done: false, date: '2026-05-28' },
    ],
  },
  {
    id: 'migracion',
    ...
    tasks: [
      ...
      { id: 'm02', text: 'M02: Crear proyecto Google Cloud + Service Account', done: false, date: '2026-04-21' },
      { id: 'm03', text: 'M03: Habilitar Gmail API + Admin SDK', done: false, date: '2026-04-21' },
      { id: 'm04', text: 'M04: Configurar delegación de dominio', done: false, date: '2026-04-22' },
      { id: 'm05', text: 'M05: Validar inventario con datos reales', done: false, date: '2026-04-23' },
      { id: 'm06', text: 'M06: Crear 11 cuentas @gmail destino', done: false, date: '2026-04-25' },
      { id: 'm07', text: 'M07: Scripts de migración desarrollados', done: false, date: '2026-04-29' },
      { id: 'm08', text: 'M08: Dry run + piloto Manuel', done: false, date: '2026-05-01' },
      { id: 'm09', text: 'M09: Tandas 1-3 (Manuel, Orlando, Nora, Delia, Nicolás, Diego)', done: false, date: '2026-05-09' },
      { id: 'm10', text: 'M10: Tandas 4-6 (Julio, José M., Victoria, Juan Á., José I.)', done: false, date: '2026-05-25' },
      { id: 'm11', text: 'M11: Transición — auto-respuesta + entrega a usuarios', done: false, date: '2026-05-30' },
    ...
    <div>
      <div style={{ display: 'flex', gap: 8, marginBottom: 20 }}>
        {['today', 'week'].map(m => (
          <button key={m} onClick={() => setMode(m)}
            style={{ padding: '8px 18px', borderRadius: 8, border: 'none', cursor: 'pointer', fontSize: 13, fontWeight: 600, background: mode === m ? '#1e293b' : '#e2e8f0', color: mode === m ? '#fff' : '#64748b' }}>
            {m === 'today' ? '📅 Hoy' : '📆 Esta semana'}
          </button>
        ))}
      </div>
      ...
      {overdueTasks.length > 0 && (
        <div style={{ background: '#fef2f2', border: '1px solid #fecaca', borderRadius: 10, padding: '12px 16px', marginBottom: 20 }}>
          <div style={{ fontWeight: 700, color: '#dc2626', fontSize: 13, marginBottom: 8 }}>⚠️ Vencidas — reprogramar</div>
      ...
      {mode === 'today' && (
        <div>
          <div style={{ fontWeight: 700, color: '#334155', fontSize: 14, marginBottom: 10 }}>
            Hoy — {fmtDate(today)}
          </div>
              ...
              <div key={iso} style={{ marginBottom: 16 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                  <span style={{ fontWeight: 700, fontSize: 13, color: isToday ? '#d97706' : isPast ? '#94a3b8' : '#334155' }}>
                    ...
                    {isToday && <span style={{ marginLeft: 6, background: '#fed7aa', color: '#d97706', borderRadius: 4, padding: '1px 6px', fontSize: 11 }}>HOY</span>}
                  </span>
